            ...
            <nav>
             <div class="menu">
                ...
                <div class="icons">
                    ...
                    <a href="customercare.php" style="display: none"><i class="fa fa-phone" aria-hidden="true"></i></a>
                </div>
            </div>
             </nav>
...
<marquee behavior="scroll" > 
    <span>HELP??   </span>   For any Technical Support CALL:<span class="promo"> +91 999-999-8888   .</span>
    <span>Rhydhm Creations </span> Call Center open to queries. Can mail us on <span class="promo">complaint@rhydhmcreations.com</span>
    </marquee>
    <div class="proleft">
...
<div class="grid">
    ...
    <div class="block">
    <div class="top"> <i class="fa fa-sliders" aria-hidden="true"></i> </div>
    <div class="bottom"> Settings </div>
    </div>

    <div class="block">
    <div class="top"> <i class="fa fa-shopping-bag" aria-hidden="true"></i> </div>
    <div class="bottom"> Order related </div>
    </div>

    <div class="block">
    <div class="top"><i class="fa fa-user" aria-hidden="true"></i> </div>
    <div class="bottom"> Profile </div>
    </div>

    <div class="block">
    <div class="top"> <i class="fa fa-money" aria-hidden="true"></i> </div>
    <div class="bottom"> Refund </div>
    </div>

    <div class="block">
    <div class="top"> <i class="fa fa-question-circle-o" aria-hidden="true"></i> </div>
    <div class="bottom"> FAQ? </div>
    </div>

    <div class="block">
    <div class="top"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
    <div class="bottom"> CALL US </div>
    </div>
...
<div class="costumerassurance">
      ...
      <div class="parts">
        ...
        <div class="proright">  
        <h1>Write to us   <i class="fa fa-envelope" aria-hidden="true" style="color:rgb(219, 233, 32)"></i></h1>       
            <div class="inputbox">
            <form action="compliant.php" class="complaintform" method="get">
                <div class="item">
                ...
                <div class="item">
                    ...
                    <input type="email" name="caddress" required>
                </div>
                <div class="item complaintbox">
                    <label>Complaint/Issue </label>
                   <!-- <input type="text" name="cname"> -->
                   <textarea name="complaint" id="complaint" required></textarea>
                </div>   
                <div class="button"><button id="csaveomplaint">SUBMIT</button></div>
                </form>
            </div>
            <div class="links">
