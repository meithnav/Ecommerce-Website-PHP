...
<div class="subbody">
    ...
    <form action="final-paymentpage.php?" action="GET">
        <input type="hidden" name="link" value="<?php  echo 'buynow'; ?>">
<?php   
...
$sku= $_GET['SKU'] ;
$porduct_type = $_GET['category'] ;
$product_category = $_GET['CATEGORY'] ;
// get all the data of the product

$product_sql = "SELECT * FROM product p JOIN image i ON p.Product_SKU = i.SKU_code JOIN details d ON p.Product_SKU = d.SKU
              WHERE p.Product_SKU = '{$sku}' " ;
$product_result = mysqli_query( $conn ,$product_sql) OR die("check query Failed") ; 
$noOfProducts = mysqli_num_rows($product_result) ;
if($noOfProducts > 0){
...
<div class="product">
<!--Saving to pass it to placeorder page-->
<input type="hidden" name="SKU" value="<?php  echo $sku; ?>">
<input type="hidden" name="category" value="<?php  echo $porduct_type ; ?>">
<input type="hidden" name="CATEGORY" value="<?php  echo $product_category; ?>">
                ...
                <div class="bar">
                    <p><a href="main-page.php">CANCEL</a> </p>
