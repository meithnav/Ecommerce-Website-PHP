...
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans:wght@700&display=swap" rel="stylesheet">
    ...
    <title>MN/Track Order</title>
    <link rel="stylesheet" href="trackingOrder.css">
</head>
<body>
<header>
            ...
            <nav>
             <div class="menu">
                ...
                <div class="icons">
                    ...
                    <a href="#"><i class="fa  fa-truck" style="display: none"></i></a>
...
$check_sql = "SELECT * FROM `orders` WHERE Cus_ID = '{$add_userId}' " ;
...
while($check_row = mysqli_fetch_assoc($check_result)){
   ...
   $sku = $check_row['Order_product_SKU'];
   $orderID = $check_row['OrderNo'] ;
   $order_status =  $check_row['Status'];
   $product_price =  $check_row['FinalPrice'] ;
   $date =  strtotime( $check_row['Date'] ) ;  //this is because 
   $date = date ( 'd  M' , $date );
 //$date = date("j M" , strtotime( $check_row['Date']));
 // echo $date ;
   $qnty = $check_row['Order_qnty'] ; 
...
?>
                ...
                <div class="pro">
                    <div class="image">
                     ...
                     <div class="details">
                         ...
                         <h3><m> Product ID </m>   <b><?php echo $sku ; ?></b></h3>
     
                         <div class="quantity">
                         <button> QNTY </button>
                            <input type="number" placeholder="<?php echo $qnty ; ?>"  readonly disabled >
                     ...
                     <div class="price">
                         ...
                         <span class="<?php echo $order_status ; ?>"><?php echo $order_status ; ?></span>  
                         </div>
              </div><!--close Pro-->
    ...
    ?>
              ...
              <div class="statusbar">
                    <div class="line"></div>
                    <div class="line2 <?php echo $order_status ; ?>"></div>

                    <div class="parts">
                    <div class="top" > PLACED <br>
                        <?php  echo  $date_split['mday'].' '.$date_split['month'];  ?>
                    </div>

                        <div class="circle ordpending<?php echo $orderID ; ?>" > &#10004; </div>
                    </div>

                    <div class="parts">
                    <div class="top" > DISPATCHED <br>
                        <?php   echo  ($date_split['mday']+1).' '.$date_split['month'];  ?> </div>

                        <div class="circle orddispatched<?php echo $orderID ; ?>" > &#10004; </div>
                    </div>
                    <div class="parts ">
                    <div class="top" > NEAR YOU <br> 
                        <?php   echo  ($date_split['mday']+5).' '.$date_split['month'];  ?></div>

                        <div class="circle ordnear<?php echo $orderID ; ?>" > &#10004; </div>
                    </div>
                    <div class="parts">
                    <div class="top" > DELIVERED <br>
                        <?php   echo  ($date_split['mday']+7).' '.$date_split['month'];  ?></div>

                        <div class="circle orddelivered<?php echo $orderID ; ?>" >  &#10004; </div>
                    </div>
              ...
              <script>
                ...
                $(document).ready(function(){
                    $(".ord<?php echo $order_status.$orderID ; ?>").css("background-color" , "rgba(71, 255, 46, 0.921)") ;
              ...
              <div class="bar">
                    <div  class="orderid"> ORDER ID : <m><?php echo $orderID ; ?></m> </div>
                <?php
                if($order_status == 'delivered'){  ?>
                
                <div  ><a class="delivered" href="updatemyorder.php?action=return&orderID=<?php echo $orderID ; ?>"> RETURN </a></div>
                <?php }
                if($order_status == 'pending'){  ?>
  
                    <div ><a class="cancelled" href="updatemyorder.php?action=cancel&orderID=<?php echo $orderID ; ?>" >CANCEL ORDER</a></div>        
                    <?php }
                         
                if($order_status == 'cancelled' || $order_status == 'returned'){ ?>    
                <div ><a class="pending"  href="buynow.php?SKU=<?php echo $sku ; ?>&category=<?php echo $porduct_type ; ?>&CATEGORY=<?php echo $porduct_category; ?>&subpage=myorder.php" > RE-ORDER </a></div>
            ...
            }else{ echo "<h1 class='norecord' >No orders have been made. Place from the <a href='shopping-page.php'> CART.</a></h1></h1>" ; } //close the num_rows =>if start after left 
        ...
        <div class="more">
            ...
            <a href="shopping-page.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i>   Visit CART </a>
