...
//Only ADMIN are allowd to edit . Also any one should not enter update page by changing the link address
...
<?php 
 ...
 //Bring all info of the Employee whose id IS PASSED ABOVE
...
<div class="group">
     ...
     <?php //Employee cant change its EID
     if( $user_role != 0){ $disabled = "disabled" ;}
            else{ $disabled = "" ;} ?>

     <input type="text" name="EID1"  value="<?php echo $row['Employee_ID'] ; ?>"  <?php echo  $disabled ; ?>  >
