...
<head>
    ...
    <!--Mukta font used in header-->
    <link href="https://fonts.googleapis.com/css2?family=Mukta:wght@500&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="store_locator.css">

    <title>MN/STORE_LOCATOR</title>
</head>
<body>
<header>
...
if(isset($_POST['l_submit'])){
    ...
    //header('Location:'.$hostname.'storelocator.php') ;
    $url = $hostname.'storelocator.php' ;
...
<li><a href="sale.php?category=Design&CATEGORY=DES"><i class="fa fa-"></i>End of Season Sale!</a></li>
<li><a href="subpage.php?category=Sale&CATEGORY=SAL"><i class="fa fa-"></i>Customized Designs</a></li>
    </ul>
...
<div class="sociallinks">
    ...
    <div class="location">
        <div class="text"> 
            ...
            <p><strong>RHYDHM CREATIONS </strong> have 200 outlets across India. Visit our stores for exclusive Jewellery.</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore cum aperiam quo magni ipsa alias 
                tempora quos cumque nobis saepe? Sint vel, ad molestiae tenetur esse nihil expedita inventore 
                blanditiis.</p>
        </div>
        <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d60332.05761456324!2d72.86072777945874!3d19.07456808762738!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1ssukkhi!5e0!3m2!1sen!2sin!4v1592392739699!5m2!1sen!2sin"
